...
class NewsArticle(TimeStampedModel):
    ...
    lead_orig = models.TextField(null=True, blank=True)
    body_orig = models.TextField(null=True, blank=True)
    lang = models.CharField(max_length=10, blank=True, default="")
    translated = models.BooleanField(default=False)
    translation_provider = models.CharField(max_length=32, blank=True, default="")
