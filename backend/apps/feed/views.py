...
class NewsIngestView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        payload["title"] = normalized_article.get("title") or payload.get("title")
        payload["lead"] = normalized_article.get("lead") or payload.get("lead")
        if "body" in payload or normalized_article.get("body") is not None:
            payload["body"] = normalized_article.get("body") or payload.get("body")
